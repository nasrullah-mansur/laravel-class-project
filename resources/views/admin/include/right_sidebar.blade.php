            ...
            <ul class="dropdown-menu slideUp2">
                ...
                <li class="body">
                    <ul class="menu list-unstyled">
                        <li>
                            <a href="javascript:void(0);" class="link-unread">
                                <div class="menu-info">
                                    <h4 class="message">There are many variations of passages of Lorem Ipsum available</h4>
                ...
                <li class="footer"> <a href="javascript:void(0);">View All Comments</a> </li>
            </ul>
        </li>
